 ...
 */
class Clasebitacorasesion extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, curso, hora, asignatura, profesorguia, numeroalumnos, bitacorasesion_id', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'bitacorasesion' => array(self::BELONGS_TO, 'Clasebitacorasesion', 'bitacorasesion_id')
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'bitacorasesion_id' => 'Bitacora sesion id',
		);
	}
