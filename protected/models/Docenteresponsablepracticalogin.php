 ...
 */
class Docenteresponsablepracticalogin extends CActiveRecord
{
    public $ConfirmClaveResponsable;
	/**
	...
	public function rules()
	{
		...
		return array(
			array('RutResponsable, ClaveResponsable, ConfirmClaveResponsable', 'required','message'=>'Por favor ingrese un valor para {attribute}.'),
			array('RutResponsable, NombreResponsable, ClaveResponsable, ConfirmClaveResponsable, MailResponsable, TelefonoResponsable, CelularResponsable, ImagenResponsable', 'length', 'max'=>45),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('RutResponsable, NombreResponsable, ClaveResponsable, ConfirmClaveResponsable, MailResponsable, TelefonoResponsable, CelularResponsable, ImagenResponsable', 'safe', 'on'=>'search'),
		);
	}
	...
	{
		return array(
			'RutResponsable' => 'Rut Responsable',
			'NombreResponsable' => 'Nombre Responsable',
			'ClaveResponsable' => 'Contraseña',
            'ConfirmClaveResponsable' => 'Confirmar Contraseña',
			'MailResponsable' => 'Mail Responsable',
			'TelefonoResponsable' => 'Telefono Responsable',
			'CelularResponsable' => 'Celular Responsable',
			'ImagenResponsable' => 'Imagen Responsable',
		);
	}
	 ...
	 * @return Docenteresponsablepracticalogin the static model class
	 */
