...
/**
 * This is the model class for table "niveleducacional".
 *
 * The followings are the available columns in table 'niveleducacional':
 * @property integer $CodNivel
 * @property string $NombreNivel
 *
 * The followings are the available model relations:
 * @property Centropractica[] $centropracticas
 */
class Niveleducacional extends CActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return array(
			'centropracticas' => array(self::HAS_MANY, 'Centropractica', 'NivelEducacional_CodNivel'),
		);
	}
	 ...
	 * @return Niveleducacional the static model class
	 */
