 ...
 * @property string $EstadoResponsable
 *
 * The followings are the available model relations:
 * @property Configuracionpractica[] $configuracionpracticas
 */
class Docenteresponsablepracticamain extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('RutResponsable, NombreResponsable, ClaveResponsable, MailResponsable, TelefonoResponsable, CelularResponsable, ImagenResponsable, EstadoResponsable', 'length', 'max'=>45),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('RutResponsable, NombreResponsable, ClaveResponsable, MailResponsable, TelefonoResponsable, CelularResponsable, ImagenResponsable, EstadoResponsable', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'ClaveResponsable' => 'Clave Responsable',
			...
			'EstadoResponsable' => 'Estado Responsable',
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('EstadoResponsable',$this->EstadoResponsable,true);
	 ...
	 * @return Docenteresponsablepracticamain the static model class
	 */
