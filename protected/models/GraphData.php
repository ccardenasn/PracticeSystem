 ...
 *
 * The followings are the available columns in table 'graph_data':
 * @property integer $id
...
class Graphdata extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('numero, idcentro', 'required'),
			array('numero, idcentro', 'numerical', 'integerOnly'=>true),
			array('nombrepractica', 'length', 'max'=>45),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, numero, nombrepractica, idcentro', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return GraphData the static model class
	 */
