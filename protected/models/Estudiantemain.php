 ...
 */
class Estudiantemain extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('RutEstudiante, NombreEstudiante, ClaveEstudiante, FechaIncorporacion, Mencion_CodMencion, MailEstudiante, TelefonoEstudiante, CelularEstudiante, ProfesorGuiaCP_RutProfGuiaCP, ConfiguracionPractica_NombrePractica, CentroPractica_RBD, ImagenEstudiante, SituacionFinalEstudiante, ObservacionEstudiante, Estado', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return Estudiantemain the static model class
	 */
