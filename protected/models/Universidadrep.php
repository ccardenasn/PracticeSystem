 ...
 * @property integer $CodInstitucion
 ...
 */
class Universidadrep extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('Region_codRegion, Provincia_codProvincia, Ciudad_codCiudad', 'required'),
	 ...
	 * @return Universidadrep the static model class
	 */
