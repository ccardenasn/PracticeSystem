...
class ProfesorcoordinadorpracticacpController extends Controller
{
	/**
	...
	public function actionUpdate($id)
	{
		...
		$imageAttrib = "ImagenProfCoordGuiaCP";
		$table = "profesorcoordinadorpracticacp";
		$codTable = "RutProfCoordGuiaCP";
	...
	{
		$dataProvider=new CActiveDataProvider('Profesorcoordinadorpracticacp');
	...
	{
		$model=new Profesorcoordinadorpracticacp('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Profesorcoordinadorpracticacp']))
			$model->attributes=$_GET['Profesorcoordinadorpracticacp'];
	 ...
	 * @return Profesorcoordinadorpracticacp the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=Profesorcoordinadorpracticacp::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Profesorcoordinadorpracticacp $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='profesorcoordinadorpracticacp-form')
		{
