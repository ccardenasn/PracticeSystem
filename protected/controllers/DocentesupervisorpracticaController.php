...
class DocentesupervisorpracticaController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			/*array('allow',  // allow all users to perform 'index' and 'view' actions
				...
				//'users'=>array('*'),
				'users'=>Docentesupervisorpractica::model()->getAdmins(),
	...
	{
		$model=new Docentesupervisorpractica;
	...
	{
		$dataProvider=new CActiveDataProvider('Docentesupervisorpractica');
	...
	{
		$model=new Docentesupervisorpractica('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Docentesupervisorpractica']))
			$model->attributes=$_GET['Docentesupervisorpractica'];
	 ...
	 * @return Docentesupervisorpractica the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=Docentesupervisorpractica::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Docentesupervisorpractica $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='docentesupervisorpractica-form')
		{
