...
$html.="<h1 align='center'>Jefe UTP CP: ".$model->NombreJefeUTPCP."</h1><br>";

$html.="<table style='width:100%' border=1 class='table-responsive'>
  <tr>
    <td><strong>Rut</strong></td>
    <td>".$model->RutJefeUTPCP."</td>
  </tr>
  <tr>
    <td><strong>Nombre</strong></td>
    <td>".$model->NombreJefeUTPCP."</td>
  </tr>
  <tr>
    <td><strong>Correo</strong></td>
    <td>".$model->MailJefeUTPCP."</td>
  </tr>
  <tr>
    <td><strong>Teléfono</strong></td>
    <td>".$model->TelefonoJefeUTPCP."</td>
  </tr>
  <tr>
    <td><strong>Celular</strong></td>
    <td>".$model->CelularJefeUTPCP."</td>
  </tr>
  <tr>
