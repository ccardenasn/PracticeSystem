...
$html.="<h1 align='center'>Docente Coordinador de Prácticas: ".$model->NombreCoordinador."</h1><br>";

$html.="<table style='width:100%' border=1 class='table-responsive'>
  <tr>
    <td><strong>Rut</strong></td>
    <td>".$model->RutCoordinador."</td>
  </tr>
  <tr>
    <td><strong>Nombre</strong></td>
    <td>".$model->NombreCoordinador."</td>
  </tr>
  <tr>
    <td><strong>Correo</strong></td>
    <td>".$model->MailCoordinador."</td>
  </tr>
  <tr>
    <td><strong>Teléfono</strong></td>
    <td>".$model->TelefonoCoordinador."</td>
  </tr>
  <tr>
    <td><strong>Celular</strong></td>
    <td>".$model->CelularCoordinador."</td>
  </tr>
  </table><br>";
