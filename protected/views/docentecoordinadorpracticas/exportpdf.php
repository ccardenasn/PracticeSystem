...
$html.="<h1 align='center'>Docente Coordinador de Prácticas</h1><br>";
...
while($i<$val){
	$html.="<tr>
			<td>".$dataProvider[$i]["RutCoordinador"]."</td>
            <td>".$dataProvider[$i]["NombreCoordinador"]."</td>
            <td>".$dataProvider[$i]["MailCoordinador"]."</td>
            <td>".$dataProvider[$i]["TelefonoCoordinador"]."</td>
            <td>".$dataProvider[$i]["CelularCoordinador"]."</td>
  		</tr>";
