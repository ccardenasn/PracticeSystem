...
$html.="<h1 align='center'>Carrera</h1><br>";
...
while($i<$val){
	$html.="<tr>
			<td>".$dataProvider[$i]["codCarrera"]."</td>
            <td>".$dataProvider[$i]["NombreCarrera"]."</td>
            <td>".$dataProvider[$i]["SemestresCarrera"]."</td>
            <td>".$dataProvider[$i]["Universidad_NombreInstitucion"]."</td>
  		</tr>";
