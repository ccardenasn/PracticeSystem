...
$('.search-form form').submit(function(){
	$('#docentesupervisorpractica-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
...
<h1>Administración de Docentes Supervisores de Prácticas</h1><br>
...
<div class="collapse">
	...
	<ul>
		<ul>
			...
			<li>Haga click sobre el símbolo <img src="images/AdminTemplates/view.png"> para visualizar información de un supervisor seleccionado en la lista.</li>
			<li>Haga click sobre el símbolo <img src="images/AdminTemplates/update.png"> para modificar información de un supervisor seleccionado en la lista.</li>
			<li>Haga click sobre el símbolo <img src="images/AdminTemplates/delete.png"> para eliminar toda la información de un supervisor seleccionado en la lista.</li>
		</ul>
		<ul>
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	'id'=>'docentesupervisorpractica-grid',
