...
for ($i=1; $i <= $totalpaginas; $i++) { 
    ...
    // y la última
         ...
         echo '<a class="btn btn-warning" href="index.php?r=timeline/lista?page='.$i.'"><i class="glyphicon glyphicon-chevron-left"></i><i class="glyphicon glyphicon-chevron-left"></i> </a>';
     }elseif ($i == $totalpaginas) {
       echo '<a class="btn btn-warning" rel="nofollow" href="index.php?r=timeline/lista?page='.$i.'"><i class="glyphicon glyphicon-chevron-right"></i><i class="glyphicon glyphicon-chevron-right"></i> </a>';
