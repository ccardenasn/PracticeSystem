...
$this->menu=array(
    ...
    array('label'=>'Crear PDF', 'url'=>array('pdf','id'=>$model->RutDirectorCP)),
);
?>
...
<div class="collapse">
	...
	<ul align=justify>
		<ul>
            ...
            <li>Haga click en <strong>"Crear PDF"</strong> para generar un documento en formato <strong>.pdf</strong> con información de director cp</li>
		</ul>
	</ul>
</div><br>
