...
$html.="<h1 align='center'>Director CP: ".$model->NombreDirectorCP."</h1><br>";

$html.="<table style='width:100%' border=1 class='table-responsive'>
  <tr>
    <td><strong>Rut</strong></td>
    <td>".$model->RutDirectorCP."</td>
  </tr>
  <tr>
    <td><strong>Nombre</strong></td>
    <td>".$model->NombreDirectorCP."</td>
  </tr>
  <tr>
    <td><strong>Correo</strong></td>
    <td>".$model->MailDirectorCP."</td>
  </tr>
  <tr>
    <td><strong>Teléfono</strong></td>
    <td>".$model->TelefonoDirectorCP."</td>
  </tr>
  <tr>
    <td><strong>Celular</strong></td>
    <td>".$model->CelularDirectorCP."</td>
  </tr>
  <tr>
