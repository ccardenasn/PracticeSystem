...
$html.="<h1 align='center'>Lista de Director CP</h1><br>";
...
while($i<$val){
	$html.="<tr>
			<td>".$dataProvider[$i]["RutDirectorCP"]."</td>
			<td>".$dataProvider[$i]["NombreDirectorCP"]."</td>
            <td>".$dataProvider[$i]["MailDirectorCP"]."</td>
            <td>".$dataProvider[$i]["TelefonoDirectorCP"]."</td>
            <td>".$dataProvider[$i]["CelularDirectorCP"]."</td>
