...
<h1>Administración de Asignaturas</h1><br>
...
<div class="collapse">
	...
	<ul align=justify>
		<ul>
			...
			<li>Haga click sobre el símbolo <img src="images/AdminTemplates/view.png"> para visualizar información de asignatura seleccionada en la lista.</li>
			<li>Haga click sobre el símbolo <img src="images/AdminTemplates/update.png"> para modificar información de asignatura seleccionada en la lista.</li>
			<li>Haga click sobre el símbolo <img src="images/AdminTemplates/delete.png"> para eliminar toda la información de asignatura seleccionada en la lista.</li>
		</ul>
		...
		<ul>
			...
			<li>Haga click en <strong>"Búsqueda Avanzada"</strong> para mostrar u ocultar opciones para encontrar una asignatura específico.</li>
