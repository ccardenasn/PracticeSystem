...
$html.="<h1 align='center'>Docente Responsable de Práctica: ".$model->NombreResponsable."</h1><br>";

$html.="<table style='width:100%' border=1 class='table-responsive'>
  <tr>
    <td><strong>Rut</strong></td>
    <td>".$model->RutResponsable."</td>
  </tr>
  <tr>
    <td><strong>Nombre</strong></td>
    <td>".$model->NombreResponsable."</td>
  </tr>
  <tr>
    <td><strong>Correo</strong></td>
    <td>".$model->MailResponsable."</td>
  </tr>
  <tr>
    <td><strong>Teléfono</strong></td>
    <td>".$model->TelefonoResponsable."</td>
  </tr>
  <tr>
    <td><strong>Celular</strong></td>
    <td>".$model->CelularResponsable."</td>
  </tr>
  </table><br>";
