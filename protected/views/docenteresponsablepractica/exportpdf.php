...
$html.="<h1 align='center'>Lista de Docentes Responsables de Prácticas</h1><br>";
...
while($i<$val){
	$html.="<tr>
			<td>".$dataProvider[$i]["RutResponsable"]."</td>
			<td>".$dataProvider[$i]["NombreResponsable"]."</td>
            <td>".$dataProvider[$i]["MailResponsable"]."</td>
            <td>".$dataProvider[$i]["TelefonoResponsable"]."</td>
            <td>".$dataProvider[$i]["CelularResponsable"]."</td>
  		</tr>";
