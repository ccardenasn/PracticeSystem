...
<table border="2px">
	...
	<tr>
		...
		<td>
			...
			<input type="button" id="btn_xa_row_b" value="x"  onclick="javascript:del_a_row_b();" style="display:none"/>
		</td>
		<td>
			<label id="lbl_b_row_b">Asignar</label>
			<input type="button" id="btn_b_row_b" value="+"  onclick="javascript:mostrar(); change_b_row_b();"/>
			<input type="button" id="btn_xb_row_b" value="x"  onclick="javascript:del_b_row_b();" style="display:none"/>
		</td>
		<td>
			<label id="lbl_c_row_b">Asignar</label>
			<input type="button" id="btn_c_row_b" value="+"  onclick="javascript:mostrar(); change_c_row_b();"/>
			<input type="button" id="btn_xc_row_b" value="x"  onclick="javascript:del_c_row_b();" style="display:none"/>
		</td>
		<td>
			<label id="lbl_d_row_b">Asignar</label>
			<input type="button" id="btn_d_row_b" value="+"  onclick="javascript:mostrar(); change_d_row_b();"/>
			<input type="button" id="btn_xd_row_b" value="x"  onclick="javascript:del_d_row_b();" style="display:none"/>
		</td>
		<td>
