...
$('.search-form form').submit(function(){
	$('#mencion-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
...
<h1>Administración de Menciones</h1><br>
...
<div class="collapse">
	...
	<ul align=justify>
		...
		<ul>
			...
			<li>Haga click en <b>"Búsqueda Avanzada"</b> para mostrar u ocultar opciones para encontrar una mención específica.</li>
