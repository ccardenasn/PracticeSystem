...
$html.="<h1 align='center'>Secretaria de Carrera: ".$model->NombreSecretaria."</h1><br>";

$html.="<table style='width:100%' border=1 class='table-responsive'>
  <tr>
    <td><strong>Rut</strong></td>
    <td>".$model->RutSecretaria."</td>
  </tr>
  <tr>
    <td><strong>Nombre</strong></td>
    <td>".$model->NombreSecretaria."</td>
  </tr>
  <tr>
    <td><strong>Correo</strong></td>
    <td>".$model->MailSecretaria."</td>
  </tr>
  <tr>
    <td><strong>Teléfono</strong></td>
    <td>".$model->TelefonoSecretaria."</td>
  </tr>
  <tr>
    <td><strong>Celular</strong></td>
    <td>".$model->CelularSecretaria."</td>
  </tr>
  <tr>
    <td><strong>Carrera</strong></td>
    <td>".$model->carreraCodCarrera->NombreCarrera."</td>
  </tr>
  </table><br>";
