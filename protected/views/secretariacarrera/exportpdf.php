...
$html.="<h1 align='center'>Secretaria de Carrera</h1><br>";
...
while($i<$val){
	$html.="<tr>
			<td>".$dataProvider[$i]["RutSecretaria"]."</td>
            <td>".$dataProvider[$i]["NombreSecretaria"]."</td>
            <td>".$dataProvider[$i]["MailSecretaria"]."</td>
            <td>".$dataProvider[$i]["TelefonoSecretaria"]."</td>
            <td>".$dataProvider[$i]["CelularSecretaria"]."</td>
  		</tr>";
