...
$html.="<h1 align='center'>Director de Carrera: ".$model->NombreDirector."</h1><br>";

$html.="<table style='width:100%' border=1 class='table-responsive'>
  <tr>
    <td><strong>Rut</strong></td>
    <td>".$model->RutDirector."</td>
  </tr>
  <tr>
    <td><strong>Nombre</strong></td>
    <td>".$model->NombreDirector."</td>
  </tr>
  <tr>
    <td><strong>Correo</strong></td>
    <td>".$model->MailDirector."</td>
  </tr>
  <tr>
    <td><strong>Teléfono</strong></td>
    <td>".$model->TelefonoDirector."</td>
  </tr>
  <tr>
    <td><strong>Celular</strong></td>
    <td>".$model->CelularDirector."</td>
  </tr>
  </table><br>";
