...
$html.="<h1 align='center'>Director de Carrera</h1><br>";
...
while($i<$val){
	$html.="<tr>
			<td>".$dataProvider[$i]["RutDirector"]."</td>
            <td>".$dataProvider[$i]["NombreDirector"]."</td>
            <td>".$dataProvider[$i]["MailDirector"]."</td>
            <td>".$dataProvider[$i]["TelefonoDirector"]."</td>
            <td>".$dataProvider[$i]["CelularDirector"]."</td>
  		</tr>";
