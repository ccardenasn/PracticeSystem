...
$html.="<h1 align='center'>Lista de Profesor Guía CP</h1><br>";
...
$html.="<table style='width:100%' border=1 class='table-responsive'>
  <tr>
    ...
    <th align='left'>Profesor Jefe</th>
...
while($i<$val){
	$html.="<tr>
			<td>".$dataProvider[$i]["RutProfGuiaCP"]."</td>
			<td>".$dataProvider[$i]["NombreProfGuiaCP"]."</td>
            <td>".$dataProvider[$i]["CursoProfGuiaCP"]."</td>
            <td>".$dataProvider[$i]["ProfesorJefeProfGuiaCP"]."</td>
            <td>".$dataProvider[$i]["MailProfGuiaCP"]."</td>
            <td>".$dataProvider[$i]["TelefonoProfGuiaCP"]."</td>
            <td>".$dataProvider[$i]["CelularProfGuiaCP"]."</td>
