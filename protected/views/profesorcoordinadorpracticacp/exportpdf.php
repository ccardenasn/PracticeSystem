...
$html.="<h1 align='center'>Lista de Profesor Coordinador Prácticas CP</h1><br>";
...
while($i<$val){
	$html.="<tr>
			<td>".$dataProvider[$i]["RutProfCoordGuiaCp"]."</td>
			<td>".$dataProvider[$i]["NombreProfCoordGuiaCP"]."</td>
            <td>".$dataProvider[$i]["MailProfCoordGuiaCP"]."</td>
            <td>".$dataProvider[$i]["TelefonoProfCoordGuiaCP"]."</td>
            <td>".$dataProvider[$i]["CelularProfCoordGuiaCP"]."</td>
