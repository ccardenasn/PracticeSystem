...
$html.="<h1 align='center'>Profesor Coordinador Práctica CP: ".$model->NombreProfCoordGuiaCP."</h1><br>";

$html.="<table style='width:100%' border=1 class='table-responsive'>
  <tr>
    <td><strong>Rut</strong></td>
    <td>".$model->RutProfCoordGuiaCp."</td>
  </tr>
  <tr>
    <td><strong>Nombre</strong></td>
    <td>".$model->NombreProfCoordGuiaCP."</td>
  </tr>
  <tr>
    <td><strong>Correo</strong></td>
    <td>".$model->MailProfCoordGuiaCP."</td>
  </tr>
  <tr>
    <td><strong>Teléfono</strong></td>
    <td>".$model->TelefonoProfCoordGuiaCP."</td>
  </tr>
  <tr>
    <td><strong>Celular</strong></td>
    <td>".$model->CelularProfCoordGuiaCP."</td>
  </tr>
  <tr>
