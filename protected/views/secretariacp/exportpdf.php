...
$html.="<h1 align='center'>Lista de Secretaria CP</h1><br>";
...
while($i<$val){
	$html.="<tr>
			<td>".$dataProvider[$i]["RutSecretariaCP"]."</td>
			<td>".$dataProvider[$i]["NombreSecretariaCP"]."</td>
            <td>".$dataProvider[$i]["MailSecretariaCP"]."</td>
            <td>".$dataProvider[$i]["TelefonoSecretariaCP"]."</td>
            <td>".$dataProvider[$i]["CelularSecretariaCP"]."</td>
