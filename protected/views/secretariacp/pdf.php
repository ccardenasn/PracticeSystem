...
$html.="<h1 align='center'>Secretaria CP: ".$model->NombreSecretariaCP."</h1><br>";

$html.="<table style='width:100%' border=1 class='table-responsive'>
  <tr>
    <td><strong>Rut</strong></td>
    <td>".$model->RutSecretariaCP."</td>
  </tr>
  <tr>
    <td><strong>Nombre</strong></td>
    <td>".$model->NombreSecretariaCP."</td>
  </tr>
  <tr>
    <td><strong>Correo</strong></td>
    <td>".$model->MailSecretariaCP."</td>
  </tr>
  <tr>
    <td><strong>Teléfono</strong></td>
    <td>".$model->TelefonoSecretariaCP."</td>
  </tr>
  <tr>
    <td><strong>Celular</strong></td>
    <td>".$model->CelularSecretariaCP."</td>
  </tr>
  <tr>
