...
$html.="<h1 align='center'>Lista de Prácticas</h1><br>";
...
while($i<$val){
	$html.="<tr>
			<td>".$dataProvider[$i]["NombrePractica"]."</td>
			<td>".$dataProvider[$i]["FechaPractica"]."</td>
            <td>".$dataProvider[$i]["Semestre_CodSemestre"]."</td>
